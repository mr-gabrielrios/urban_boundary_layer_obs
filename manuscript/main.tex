...
%%% Prathap to add text regarding vertical motion, this area feels lacking
...
Days with identifiable sea breeze events had lower $U$ throughout the majority of the UBL, with the most significant decreases during the nighttime, potentially due to the lessening of onshore flow due to the reduction of the land-sea temperature gradient \citep{pullen2007}, as shown in Figure \ref{fig:sea_breeze-lst_sst-diff}. Vertical motions, however, increased significantly in the Bronx and Queens during the late morning and early afternoon, as shown in Figure \ref{fig:sea_breeze_heat_wave_anomaly-w}. These anomalies indicate the increased presence of updrafts in urbanized areas which contribute to low-level convergence, promoting onshore flow in the afternoon and evening.
\\ \\
During extreme heat days with identified sea breeze circulations, easterly winds increase in frequency in the lower levels of the UBL, as shown in Figures \ref{fig:wind_direction-heat_wave-sea_breeze-histogram-bron}, \ref{fig:wind_direction-heat_wave-sea_breeze-histogram-quee}, and \ref{fig:wind_direction-heat_wave-sea_breeze-histogram-stat}. These winds are the result of onshore flow from the New York Bight (southeasterly) and Long Island Sound (northeasterly). 
\\ \\
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{figs/observation_count_mwr.png}
	\caption{Microwave radiometer observation statistics for all sites at selected heights.}
	\label{fig:land_cover}
\end{figure}
 
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{figs/observation_count_lidar.png}
	\caption{Lidar observation statistics for all sites.}
	\label{fig:building_heights}
\end{figure}
