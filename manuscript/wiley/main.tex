...
\usepackage{xcolor}
% Handle tables
\usepackage{tabularx, caption, subfigure}
% Handle figures
\usepackage{graphicx}
...
\corraddress{Gabriel Rios, epartment of Mechanical Engineering, CUNY City College, New York, New York}
\corremail{grios001@citymail.cuny.edu}

\fundinginfo{}

% Include the name of the author that should appear in the running header
\runningauthor{Rios \& Ramamurthy}
...
\begin{figure*}[t!]
	\centering
	\subfigure[Figure A]{
		\includegraphics[width=0.45\textwidth]{figs/building_heights.png}
	}
	\subfigure[Figure A]{
		\includegraphics[width=0.45\textwidth]{figs/land_cover.png}
	}
